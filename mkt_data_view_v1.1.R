...
# Change Indicators
## Add 50 to negative value
for (i in 1:2) {
  Indicators[,i] <- Indicators[,i] + 50
}
...
corstarsl(cbind(Asset_data, Indicators)[-3:-1])[6:37,1:5] #Pearson Corr
corstarsl(cbind(Asset_data, Indicators)[-3:-1],type="spearman")[6:37,1:5] #Spearman Corr

corstarsl(cbind(Asset_data, Indicators)['2008-03/'])[6:37,1:5] #Pearson Corr
corstarsl(cbind(Asset_data, Indicators)['2008-03/'],type="spearman")[6:37,1:5] #Spearman Corr
