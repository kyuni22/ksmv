...
file2 <- "./data/EC_Econ_Indicators2.csv"
...
corstarsl(cbind(Asset_data, Indicators)[-3:-1])[6:13,1:5] #Pearson Corr
corstarsl(cbind(Asset_data, Indicators)[-3:-1],type="spearman")[6:13,1:5] #Spearman Corr

corstarsl(cbind(Asset_data, Indicators)['2008-03/'])[6:13,1:5] #Pearson Corr
corstarsl(cbind(Asset_data, Indicators)['2008-03/'],type="spearman")[6:13,1:5] #Spearman Corr
